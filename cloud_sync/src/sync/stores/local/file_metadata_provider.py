...
class FileMetadataProvider:
    ...
    def get_file(self, file_cloud_path: str) -> LocalFileMetadata:
        ...
        file_name = path_helper.get_file_name(local_path)
        file_extension = path_helper.get_file_extension(local_path)
    ...
    def __name_to_cloud_path(self, name: str, parent_cloud_path: str) -> str:
        ...
        return path_helper.start_with_slash(self.__join_path(parent_cloud_path, normalized_name))
    ...
    def __get_folder(self, cloud_path: str) -> LocalFolderMetadata:
        ...
        name = path_helper.get_file_name(local_path)
