...
class CommandRunner:
    ...
    def __sync(self, cloud_path: str, download: bool, upload: bool):
        self._ui.message('Synchronizing {} cloud folder'.format(cloud_path))
        self._ui.message('Download files {}'.format(download))
        self._ui.message('Upload files {}'.format(upload))
