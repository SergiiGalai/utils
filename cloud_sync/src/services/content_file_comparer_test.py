...
class ContentFileComparerTests(unittest.TestCase):
   ...
   def _createLocalFile(self, modified_day = 1, size=2000, name = _FILE_NAME):
      return LocalFileMetadata(name, self._CLOUD_FILE_PATH, datetime.datetime(2023, 8, modified_day, 20, 14, 14), size, self._LOCAL_FILE_PATH )

   def _createCloudFile(self, modified_day = 1, size=2000, name = _FILE_NAME):
      return CloudFileMetadata(name, self._CLOUD_FILE_PATH, datetime.datetime(2023, 8, modified_day, 20, 14, 14), size, self._CLOUD_FILE_PATH, '123321' )
